...
# BMI calculator with a user friendly interface GUI using libraries like Tkinter or PYQT.
...
weight_lable = customtkinter.CTkLabel(app,font=font2,text='Weight',text_color='#fff',bg_color='#000')
weight_lable.place(x=20,y=80)

height_lable = customtkinter.CTkLabel(app,font=font2,text='Height',text_color='#fff',bg_color='#000')
height_lable.place(x=20,y=150)
